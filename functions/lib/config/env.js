...
exports.env = {
    ...
    geminiFlashModel: process.env.GEMINI_FLASH_MODEL || 'gemini-3-flash',
    imagenModel: process.env.IMAGEN_MODEL || 'imagen-3-fast',
    veoModel: process.env.VEO_MODEL || 'veo-3-fast',
    lyriaModel: process.env.LYRIA_MODEL || 'lyria-2',
    // App Config
...
function validateEnv() {
    const warnings = [];
    if (!exports.env.stripeSecretKey) {
